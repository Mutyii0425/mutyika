...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2025. Feb 28. 20:53
...
INSERT INTO `termekek` (`t_azonosito`, `t_nev`, `t_ar`, `egysegar`, `t_csoport`, `termekleiras`, `meret`, `szin`) VALUES
(9, 'Póló', 1500, 2000, 4, 'Ez a polo elég jó és minőségi', 'XL', 'fehér'),
(10, 'Póló', 1500, 2000, 4, 'Ez a polo elég jó és minőségi', 'XL', 'fekete'),
(11, 'Póló', 1500, 2000, 4, 'Ez a polo elég jó és minőségi', 'XL', 'szürke'),
(13, 'Pulóver', 20000, 20000, 5, 'Ez a púolver minőségi', 'XL', 'fekete'),
(14, 'Pulóver', 20000, 20000, 5, 'Ez a púolver minőségi', 'XL', 'fekete'),
(15, 'Pulóver', 20000, 20000, 5, 'Ez a púolver minőségi', 'XL', 'fekete');
...
ALTER TABLE `usertermekek`
  ...
  ADD CONSTRAINT `usertermekek_ibfk_2` FOREIGN KEY (`kategoriaId`) REFERENCES `termekek` (`t_csoport`);
COMMIT;
